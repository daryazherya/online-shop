...
import DeleteCartIcon from '@mui/icons-material/Delete';
...
export const Favorites = () => {
    ...
    const { data, isLoading ,refetch } = useQuery({ queryKey: ['favoritesProducts'], queryFn: () => getFilteredProducts(favorites) });
    const handleDeleteFavorites = useStore(((state) => state.deleteFavoriteThing));
            ...
            >
                ...
                <CardActions sx={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <IconButton
                        ...
                        onClick={() => handleDeleteFavorites(product.id)}
                    >
                        <DeleteCartIcon />
                    </IconButton>
                </CardActions>
